// src/app/(protected)/penilaian-bisnis/team-dynamics/components/AssessmentSection.tsx
'use client';
 ...
 * Handles the quiz/assessment portion of the team dynamics evaluation
...
export default function AssessmentSection({ onComplete }: AssessmentSectionProps) {
  ...
  // Handle next section or completion
  const handleNext = () => {
